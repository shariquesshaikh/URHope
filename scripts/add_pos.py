...
db = pymysql.connect(host='localhost', user='root', passwd='jijoleelamma',
...
files = ["GoaC.csv", "UTC.csv", "Initiatives-05-05-2020C.csv", "Initiatives-06-05-2020C.csv", "Initiatives-12-05-2020C.csv"]
for file in files:
