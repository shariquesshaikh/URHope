...
function autocomplete(inp, arr) {
    ...
    inp.addEventListener("input", function (e) {
        ...
        for (i = 0; i < arr.length; i++) {
            ...
            if (arr[i].toUpperCase().includes(val.toUpperCase()) && count < 50) {
                ...
                var len_of_arr = arr[i].toUpperCase().length;
                b.innerHTML = arr[i].substr(0, index);
                b.innerHTML += "<strong>" + arr[i].substr(index, val.length) + "</strong>";
                b.innerHTML += arr[i].substr(index + val.length, len_of_arr);
                ...
                if (count === 50) {
                    ...
                    var index = arr[i].toUpperCase().indexOf(val.toUpperCase());
                    var len_of_arr = arr[i].toUpperCase().length;
                    b.innerHTML = "Showing only top 50 results";
                    a.appendChild(b);
                }
            }
